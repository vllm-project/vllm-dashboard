...
- **Force-merges** — how often vLLM PRs override CI through the `vllm-bot`
  force-merge path: rate windows, weekly trend, merge volume, top PR authors,
  and recent force-merged PRs.
...
- **Sources polled**:
  ...
  - GitHub GraphQL API (merged-PR force-merge records) — daily
