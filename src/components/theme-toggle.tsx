...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="dashboard-control grid h-11 w-11 place-items-center rounded-md text-muted hover:bg-zinc-100 hover:text-zinc-900 dark:hover:bg-zinc-800 dark:hover:text-zinc-100 sm:h-10 sm:w-10"
    >
